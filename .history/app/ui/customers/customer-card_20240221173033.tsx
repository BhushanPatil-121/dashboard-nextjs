    ...
    return (
        <div style={{
            ...
            {customers?.map((customer) => (
                <div style={{margin:"0 auto"}} key={customer.id} >
                    <List sx={{ width: '100%', minWidth: 320, maxWidth: 320, bgcolor: 'background.paper',display:'flex',justifyContent:'center',alignItems:'center' , textAlign:'centre'}}>
