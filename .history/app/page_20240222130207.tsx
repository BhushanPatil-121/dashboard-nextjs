      ...
      <div className="flex grow flex-col  gap-3 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          ...
          <p className={`${lusitana.className}  text-xl text-gray-800 md:text-3xl md:leading-normal `}>
            <strong>Welcome to InvoiceTrackr.</strong> Effortlessly manage your finances with our intuitive Invoice Tracker. Keep a keen eye on all your invoices, whether pending or paid, with comprehensive tracking features designed to streamline your financial management.
          </p>
          <Link
            href="/login"
